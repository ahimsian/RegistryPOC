 ...
 *  
 */
package com.hybris.belk.poc.jalo;
...
import com.hybris.belk.poc.constants.RegistryPOCConstants;



/**
 * This is the extension manager of the RegistryPOC extension.
 */
public class RegistryPOCManager extends GeneratedRegistryPOCManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RegistryPOCManager.class.getName());
	 ...
	 */
	public static RegistryPOCManager getInstance()
	{
		return (RegistryPOCManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				RegistryPOCConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public RegistryPOCManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of RegistryPOCManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RegistryPOCManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RegistryPOCManager called, current tenant: " + getTenant().getTenantID());
		}
	}
